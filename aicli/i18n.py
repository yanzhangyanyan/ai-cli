...
Config file: {config_path}""",
        ...
        "ready_agent": "  {host} ready — Agent mode",
        "task_hint": "  Type a task description, Agent will plan and execute:",
        "task_ex1": "    check system info",
        "task_ex2": "    install Docker and deploy RAGFlow",
        "task_ex3": "    check Nginx config and restart",
        "usage_commands": "  Commands:",
        "usage_probe": "    probe            Detect system info",
        "usage_exec": "    exec <cmd>       Execute a single command",
        "usage_context": "    context <desc>   Set project context",
        "usage_control": "  Execution control:",
        "ctrl_auto": "    [auto]           Low-risk ops auto-execute",
        "ctrl_confirm": "    [confirm]        High-risk ops require Y",
        "ctrl_pause": "    Ctrl+C           Pause task, give feedback",
        "ctrl_quit": "    quit/exit        Exit aicli",
        "probe_title": "\nSystem info:",
        "probe_host": "  Host:  {hostname} | IP: {ip}",
        "probe_kernel": "  Kernel:{kernel}",
        "probe_cpu": "  CPU:   {cores} cores",
        "probe_ram": "  RAM:   {ram}GB",
        "probe_disk": "  Disk:  {used}GB / {total}GB",
        "probe_pkg": "  Pkg:   {pkg}",
        "probe_installed": "  Installed: {items}",
    },
    "zh": {
...
配置文件: {config_path}""",
        ...
        "cfg_thinking_on": "开启",
        "cfg_thinking_off": "关闭",
        "ready_agent": "  {host} 已就绪 — Agent 模式",
        "task_hint": "  直接输入任务描述，Agent 自动规划并执行:",
        "task_ex1": "    查看系统信息",
        "task_ex2": "    安装 Docker 并部署 RAGFlow",
        "task_ex3": "    检查 Nginx 配置并重启",
        "usage_commands": "  命令:",
        "usage_probe": "    probe            探测系统",
        "usage_exec": "    exec <命令>      手动执行单条命令",
        "usage_context": "    context <描述>   设置项目上下文",
        "usage_control": "  执行控制:",
        "ctrl_auto": "    [auto]           低风险操作自动执行",
        "ctrl_confirm": "    [需确认]         高风险操作需 Y 确认",
        "ctrl_pause": "    Ctrl+C           暂停当前任务，可给反馈",
        "ctrl_quit": "    quit/exit        退出 aicli",
        "probe_title": "\n系统信息:",
        "probe_host": "  主机:  {hostname} | IP: {ip}",
        "probe_kernel": "  内核:  {kernel}",
        "probe_cpu": "  CPU:   {cores}核",
        "probe_ram": "  内存:  {ram}GB",
        "probe_disk": "  磁盘:  {used}GB / {total}GB",
        "probe_pkg": "  包管:  {pkg}",
        "probe_installed": "  已装:  {items}",
    },
}

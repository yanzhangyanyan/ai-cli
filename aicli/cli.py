...
def _print_usage_after_connect(probe_data: dict | None):
    ...
    print(f"{'─' * 50}")
    print()
    print("  Type a task description, Agent will plan and execute:")
    print("    check system info")
    print("    install Docker and deploy RAGFlow")
    ...
    print("    [auto]           Low-risk ops auto-execute")
